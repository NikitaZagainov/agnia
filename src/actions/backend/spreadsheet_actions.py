...
def query_sheet(auth_data: dict, input_params: DownloadAndQuerySheetInputParams) -> DownloadAndQuerySheetOutputParams:
    ...
    query = service.generate_sql_query(
        input_params.message, data_frame, df_schema)
...
def postprocess_sheet(auth_data: dict, input_params: SheetPostprocessingInputParams) -> SheetPostprocessingOutputParams:
